      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          <div className="flex flex-row items-center ">
            ...
            <p className=" font-inter text-base font-medium tracking-normal leading-none text-center mr-2 cursor-pointer">
              Wish List
            </p>
          </div>
          <div
            className="flex flex-row items-center cursor-pointer pl-16"
            onClick={handleOpen}
          >
            {totalAmount > 0 ? (
          ...
          <div className="flex flex-row items-center cursor-pointer pl-4">
            ...
            <div onClick={() => dispatch(logout())} className="pl-32">
              <Tooltip content="Sign Out" placement="bottom">
                <p className="font-inter text-lg m-7 font-medium tracking-normal leading-none">
